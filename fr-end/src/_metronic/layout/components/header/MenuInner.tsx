    ...
    <>
      ...
      <MenuInnerWithSub title='Apps' to='/apps' menuPlacement='bottom-start' menuTrigger='click'>
        ...
        <MenuInnerWithSub
          ...
          menuTrigger={`{default:'click', lg: 'hover'}`}
        >
          <MenuItem to='/apps/tiktok/private-chat' title='Tiktok Live' hasBullet={true} />
          <MenuItem to='/apps/tiktok/group-chat' title='Tiktok..' hasBullet={true} />
          <MenuItem to='/apps/tiktok/users/:userId' title='Tiktok..' hasBullet={true} />
        </MenuInnerWithSub>
        <MenuItem
