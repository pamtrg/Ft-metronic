...
function groupingOnSelect(
  ...
  if (selected.includes(channelId)) {
    setSelected(selected.filter((itemId) => itemId !== channelId))
  } else {
    const updatedSelected = [...selected]
    updatedSelected.push(channelId)
...
function groupingOnSelectAll<T>(
  ...
  setSelected(data.filter((item) => item.channelId).map((item) => item.channelId))
}
